...
if (existsSync(envLocalPath)) {
  ...
  console.warn("⚠️ No .env.local or .env file found, continuing without custom domain.");
}
...
if (!domain) {
  console.error("❌ Missing VITE_CUSTOM_DOMAIN in your environment file (.env.local or .env)");
  process.exit(1);
}
